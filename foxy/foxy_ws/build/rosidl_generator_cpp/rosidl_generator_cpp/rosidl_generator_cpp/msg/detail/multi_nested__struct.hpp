...
struct MultiNested_
{
  ...
  using _bounded_sequence_of_arrays_type =
    rosidl_runtime_cpp::BoundedVector<rosidl_generator_cpp::msg::Arrays_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_cpp::msg::Arrays_<ContainerAllocator>>::other>;
  _bounded_sequence_of_arrays_type bounded_sequence_of_arrays;
  using _bounded_sequence_of_bounded_sequences_type =
    rosidl_runtime_cpp::BoundedVector<rosidl_generator_cpp::msg::BoundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_cpp::msg::BoundedSequences_<ContainerAllocator>>::other>;
  ...
  using _bounded_sequence_of_unbounded_sequences_type =
    rosidl_runtime_cpp::BoundedVector<rosidl_generator_cpp::msg::UnboundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_cpp::msg::UnboundedSequences_<ContainerAllocator>>::other>;
  ...
  Type & set__bounded_sequence_of_arrays(
    const rosidl_runtime_cpp::BoundedVector<rosidl_generator_cpp::msg::Arrays_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_cpp::msg::Arrays_<ContainerAllocator>>::other> & _arg)
  {
    this->bounded_sequence_of_arrays = _arg;
    return *this;
  }
  Type & set__bounded_sequence_of_bounded_sequences(
    const rosidl_runtime_cpp::BoundedVector<rosidl_generator_cpp::msg::BoundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_cpp::msg::BoundedSequences_<ContainerAllocator>>::other> & _arg)
  {
    this->bounded_sequence_of_bounded_sequences = _arg;
    return *this;
  }
  Type & set__bounded_sequence_of_unbounded_sequences(
    const rosidl_runtime_cpp::BoundedVector<rosidl_generator_cpp::msg::UnboundedSequences_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_cpp::msg::UnboundedSequences_<ContainerAllocator>>::other> & _arg)
  {
