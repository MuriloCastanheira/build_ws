  ...
  rosidl_generator_py__msg__Nested__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rosidl_generator_py__msg__Nested * data =
      (rosidl_generator_py__msg__Nested *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_py__msg__Nested__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rosidl_generator_py__msg__Nested__fini(&data[i]);
        }
        free(data);
        return false;
      }
