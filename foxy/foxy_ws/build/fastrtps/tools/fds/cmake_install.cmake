# Install script for directory: /workspace/foxy_ws/src/fastrtps/tools/fds
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xdiscoveryx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/workspace/foxy_ws/build/fastrtps/tools/fds/fast-discovery-server-1.0.0")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/fast-discovery-server-1.0.0" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/fast-discovery-server-1.0.0")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/fast-discovery-server-1.0.0"
         OLD_RPATH "/workspace/foxy_ws/build/fastrtps/src/cpp:/workspace/foxy_ws/install/lib:"
         NEW_RPATH "")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcmakex" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/fastrtps/cmake/fast-discovery-server-targets.cmake")
    file(DIFFERENT EXPORT_FILE_CHANGED FILES
         ...
         "/workspace/foxy_ws/build/fastrtps/tools/fds/CMakeFiles/Export/share/fastrtps/cmake/fast-discovery-server-targets.cmake")
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/fastrtps/cmake" TYPE FILE FILES "/workspace/foxy_ws/build/fastrtps/tools/fds/CMakeFiles/Export/share/fastrtps/cmake/fast-discovery-server-targets.cmake")
  if("${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "^([Rr][Ee][Ll][Ee][Aa][Ss][Ee])$")
    file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/fastrtps/cmake" TYPE FILE FILES "/workspace/foxy_ws/build/fastrtps/tools/fds/CMakeFiles/Export/share/fastrtps/cmake/fast-discovery-server-targets-release.cmake")
  endif()
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xdiscoveryx" OR NOT CMAKE_INSTALL_COMPONENT)
  execute_process(COMMAND bash -c "if [[ -h fast-discovery-server ]]; then rm fast-discovery-server; fi;  ln -s fast-discovery-server-1.0.0 fast-discovery-server" WORKING_DIRECTORY "/workspace/foxy_ws/install/bin")
endif()
