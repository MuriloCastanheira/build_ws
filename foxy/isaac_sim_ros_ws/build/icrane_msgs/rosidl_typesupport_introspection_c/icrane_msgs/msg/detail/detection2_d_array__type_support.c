...
#include <stddef.h>
#include "icrane_msgs/msg/detail/detection2_d_array__rosidl_typesupport_introspection_c.h"
...
// Member `detections`
#include "icrane_msgs/msg/detection2_d.h"
// Member `detections`
#include "icrane_msgs/msg/detail/detection2_d__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  icrane_msgs__msg__Detection2DArray__init(message_memory);
}

void Detection2DArray__rosidl_typesupport_introspection_c__Detection2DArray_fini_function(void * message_memory)
{
  icrane_msgs__msg__Detection2DArray__fini(message_memory);
}

size_t Detection2DArray__rosidl_typesupport_introspection_c__size_function__Detection2D__detections(
  const void * untyped_member)
{
  const icrane_msgs__msg__Detection2D__Sequence * member =
    (const icrane_msgs__msg__Detection2D__Sequence *)(untyped_member);
  return member->size;
}
...
{
  icrane_msgs__msg__Detection2D__Sequence * member =
    (icrane_msgs__msg__Detection2D__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  icrane_msgs__msg__Detection2D__Sequence * member =
    (icrane_msgs__msg__Detection2D__Sequence *)(untyped_member);
  icrane_msgs__msg__Detection2D__Sequence__fini(member);
  return icrane_msgs__msg__Detection2D__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Detection2DArray__rosidl_typesupport_introspection_c__Detection2DArray_message_member_array[2] = {
  {
    ...
    offsetof(icrane_msgs__msg__Detection2DArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs__msg__Detection2DArray, detections),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Detection2DArray__rosidl_typesupport_introspection_c__Detection2DArray_message_members = {
  ...
  2,  // number of fields
  sizeof(icrane_msgs__msg__Detection2DArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, icrane_msgs, msg, Detection2DArray)() {
  ...
  Detection2DArray__rosidl_typesupport_introspection_c__Detection2DArray_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, icrane_msgs, msg, Detection2D)();
