...
// Member `center`
#include "icrane_msgs/msg/pose2_d.h"
// Member `center`
#include "icrane_msgs/msg/detail/pose2_d__rosidl_typesupport_introspection_c.h"
// Member `size`
#include "icrane_msgs/msg/vector2_d.h"
// Member `size`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  icrane_msgs__msg__BoundingBox2D__init(message_memory);
}

void BoundingBox2D__rosidl_typesupport_introspection_c__BoundingBox2D_fini_function(void * message_memory)
{
  icrane_msgs__msg__BoundingBox2D__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember BoundingBox2D__rosidl_typesupport_introspection_c__BoundingBox2D_message_member_array[2] = {
  {
    ...
    offsetof(icrane_msgs__msg__BoundingBox2D, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs__msg__BoundingBox2D, size),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBox2D__rosidl_typesupport_introspection_c__BoundingBox2D_message_members = {
  ...
  2,  // number of fields
  sizeof(icrane_msgs__msg__BoundingBox2D),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, icrane_msgs, msg, BoundingBox2D)() {
  BoundingBox2D__rosidl_typesupport_introspection_c__BoundingBox2D_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, icrane_msgs, msg, Pose2D)();
