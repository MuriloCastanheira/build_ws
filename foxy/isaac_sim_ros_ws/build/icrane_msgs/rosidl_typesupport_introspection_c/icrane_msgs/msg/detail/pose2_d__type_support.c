  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  icrane_msgs__msg__Pose2D__init(message_memory);
}

void Pose2D__rosidl_typesupport_introspection_c__Pose2D_fini_function(void * message_memory)
{
  icrane_msgs__msg__Pose2D__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Pose2D__rosidl_typesupport_introspection_c__Pose2D_message_member_array[3] = {
  {
    ...
    offsetof(icrane_msgs__msg__Pose2D, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs__msg__Pose2D, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs__msg__Pose2D, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Pose2D__rosidl_typesupport_introspection_c__Pose2D_message_members = {
  ...
  "Pose2D",  // message name
  3,  // number of fields
  sizeof(icrane_msgs__msg__Pose2D),
