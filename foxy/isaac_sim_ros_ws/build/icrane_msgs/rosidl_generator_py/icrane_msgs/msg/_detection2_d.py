...
class Metaclass_Detection2D(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from icrane_msgs.msg import BoundingBox2D
...
class Detection2D(metaclass=Metaclass_Detection2D):
    ...
    _fields_and_field_types = {
        ...
        'score': 'double',
        'id': 'string',
        'bbox': 'icrane_msgs/BoundingBox2D',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['icrane_msgs', 'msg'], 'BoundingBox2D'),  # noqa: E501
    )
