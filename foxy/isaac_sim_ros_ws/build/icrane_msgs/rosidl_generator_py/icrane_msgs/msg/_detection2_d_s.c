...
bool icrane_msgs__msg__detection2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("icrane_msgs.msg._detection2_d.Detection2D", full_classname_dest, 41) == 0);
  }
  icrane_msgs__msg__Detection2D * ros_message = _ros_message;
  {  // class_id
  ...
  {  // bbox
    ...
    if (!icrane_msgs__msg__bounding_box2_d__convert_from_py(field, &ros_message->bbox)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * icrane_msgs__msg__detection2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("icrane_msgs.msg._detection2_d");
  ...
  {  // bbox
    PyObject * field = NULL;
    field = icrane_msgs__msg__bounding_box2_d__convert_to_py(&ros_message->bbox);
    if (!field) {
      return NULL;
    }
    {
