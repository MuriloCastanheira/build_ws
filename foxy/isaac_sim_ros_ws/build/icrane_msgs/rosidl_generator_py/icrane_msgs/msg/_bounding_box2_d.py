...
class BoundingBox2D(metaclass=Metaclass_BoundingBox2D):
    ...
    _fields_and_field_types = {
        'center': 'icrane_msgs/Pose2D',
        'size': 'icrane_msgs/Vector2D',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['icrane_msgs', 'msg'], 'Pose2D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['icrane_msgs', 'msg'], 'Vector2D'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from icrane_msgs.msg import Vector2D
        self.size = kwargs.get('size', Vector2D())
    ...
    def size(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'size' field must be a sub message of type 'Vector2D'"
        self._size = value
