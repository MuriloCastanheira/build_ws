...
bool icrane_msgs__msg__tracked_entities__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("icrane_msgs.msg._tracked_entities.TrackedEntities", full_classname_dest, 49) == 0);
  }
  icrane_msgs__msg__TrackedEntities * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of TrackedEntities */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("icrane_msgs.msg._tracked_entities");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackedEntities");
