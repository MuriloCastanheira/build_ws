...
static const _Detection2D_type_support_symbol_names_t _Detection2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, icrane_msgs, msg, Detection2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, icrane_msgs, msg, Detection2D)),
  }
};
...
{
  return &::icrane_msgs::msg::rosidl_typesupport_cpp::Detection2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, icrane_msgs, msg, Detection2D)() {
  return get_message_type_support_handle<icrane_msgs::msg::Detection2D>();
}
