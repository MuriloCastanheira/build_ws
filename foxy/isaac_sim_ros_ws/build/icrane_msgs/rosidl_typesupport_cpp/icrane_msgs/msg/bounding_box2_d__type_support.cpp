...
static const _BoundingBox2D_type_support_symbol_names_t _BoundingBox2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, icrane_msgs, msg, BoundingBox2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, icrane_msgs, msg, BoundingBox2D)),
  }
};
...
{
  return &::icrane_msgs::msg::rosidl_typesupport_cpp::BoundingBox2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, icrane_msgs, msg, BoundingBox2D)() {
  return get_message_type_support_handle<icrane_msgs::msg::BoundingBox2D>();
}
