...
static const _Detection2DArray_type_support_symbol_names_t _Detection2DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, icrane_msgs, msg, Detection2DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, icrane_msgs, msg, Detection2DArray)),
  }
};
...
{
  return &::icrane_msgs::msg::rosidl_typesupport_cpp::Detection2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, icrane_msgs, msg, Detection2DArray)() {
  return get_message_type_support_handle<icrane_msgs::msg::Detection2DArray>();
}
