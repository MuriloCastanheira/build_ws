...
{
  new (message_memory) icrane_msgs::msg::Pose2D(_init);
}

void Pose2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<icrane_msgs::msg::Pose2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose2D_message_member_array[3] = {
  {
    ...
    offsetof(icrane_msgs::msg::Pose2D, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs::msg::Pose2D, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs::msg::Pose2D, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<icrane_msgs::msg::Pose2D>()
{
  return &::icrane_msgs::msg::rosidl_typesupport_introspection_cpp::Pose2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, icrane_msgs, msg, Pose2D)() {
  return &::icrane_msgs::msg::rosidl_typesupport_introspection_cpp::Pose2D_message_type_support_handle;
}
