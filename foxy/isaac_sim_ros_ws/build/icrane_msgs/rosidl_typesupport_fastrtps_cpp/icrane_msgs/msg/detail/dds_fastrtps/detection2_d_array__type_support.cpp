...
#include "icrane_msgs/msg/detail/detection2_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const icrane_msgs::msg::Detection2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  icrane_msgs::msg::Detection2D &);
size_t get_serialized_size(
  const icrane_msgs::msg::Detection2D &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const icrane_msgs::msg::Detection2DArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  icrane_msgs::msg::Detection2DArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        icrane_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection2D(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const icrane_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<icrane_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  return &icrane_msgs::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, icrane_msgs, msg, Detection2DArray)() {
  return &icrane_msgs::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
