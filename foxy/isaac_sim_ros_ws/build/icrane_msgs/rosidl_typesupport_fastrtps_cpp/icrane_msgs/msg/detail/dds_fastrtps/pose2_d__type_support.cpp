...
#include "icrane_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const icrane_msgs::msg::Pose2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  icrane_msgs::msg::Pose2D & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const icrane_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<icrane_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  return &icrane_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, icrane_msgs, msg, Pose2D)() {
  return &icrane_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
