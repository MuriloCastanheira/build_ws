...
#include "icrane_msgs/msg/detail/vector2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const icrane_msgs::msg::Vector2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<icrane_msgs::msg::Vector2D *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Vector2D(full_bounded, 0);
}
...
{
  return &icrane_msgs::msg::typesupport_fastrtps_cpp::_Vector2D__handle;
}
