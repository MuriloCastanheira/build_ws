...
#include "icrane_msgs/msg/detail/detection_seg3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const icrane_msgs::msg::DetectionSeg3D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  icrane_msgs::msg::DetectionSeg3D & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
...
{
  auto typed_message =
    static_cast<const icrane_msgs::msg::DetectionSeg3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<icrane_msgs::msg::DetectionSeg3D *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectionSeg3D__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const icrane_msgs::msg::DetectionSeg3D *>(
...
{
  return max_serialized_size_DetectionSeg3D(full_bounded, 0);
}

static message_type_support_callbacks_t _DetectionSeg3D__callbacks = {
  "icrane_msgs::msg",
  "DetectionSeg3D",
...
static rosidl_message_type_support_t _DetectionSeg3D__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectionSeg3D__callbacks,
...
{
  return &icrane_msgs::msg::typesupport_fastrtps_cpp::_DetectionSeg3D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, icrane_msgs, msg, DetectionSeg3D)() {
  return &icrane_msgs::msg::typesupport_fastrtps_cpp::_DetectionSeg3D__handle;
}
