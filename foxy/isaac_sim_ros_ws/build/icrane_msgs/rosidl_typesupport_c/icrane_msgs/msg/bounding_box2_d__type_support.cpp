...
static const _BoundingBox2D_type_support_symbol_names_t _BoundingBox2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, icrane_msgs, msg, BoundingBox2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, icrane_msgs, msg, BoundingBox2D)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, icrane_msgs, msg, BoundingBox2D)() {
  return &::icrane_msgs::msg::rosidl_typesupport_c::BoundingBox2D_message_type_support_handle;
}
