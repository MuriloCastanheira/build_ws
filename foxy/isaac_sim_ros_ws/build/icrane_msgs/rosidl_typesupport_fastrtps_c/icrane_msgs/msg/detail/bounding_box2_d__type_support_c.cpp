...
#include "icrane_msgs/msg/detail/bounding_box2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "icrane_msgs/msg/detail/pose2_d__functions.h"  // center
#include "icrane_msgs/msg/detail/vector2_d__functions.h"  // size

// forward declare type support functions
size_t get_serialized_size_icrane_msgs__msg__Pose2D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_icrane_msgs__msg__Pose2D(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, icrane_msgs, msg, Pose2D)();
...
using _BoundingBox2D__ros_msg_type = icrane_msgs__msg__BoundingBox2D;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: center
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, icrane_msgs, msg, Pose2D
      )()->data);
  ...
  // Field name: size
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, icrane_msgs, msg, Vector2D
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_icrane_msgs__msg__BoundingBox2D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingBox2D__ros_msg_type * ros_message = static_cast<const _BoundingBox2D__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_icrane_msgs__msg__Pose2D(
    &(ros_message->center), current_alignment);
  // field.name size

  current_alignment += get_serialized_size_icrane_msgs__msg__Vector2D(
...
static uint32_t _BoundingBox2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_icrane_msgs__msg__BoundingBox2D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_icrane_msgs
size_t max_serialized_size_icrane_msgs__msg__BoundingBox2D(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: center
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_icrane_msgs__msg__Pose2D(
  ...
  // member: size
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_icrane_msgs__msg__Vector2D(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_icrane_msgs__msg__BoundingBox2D(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, icrane_msgs, msg, BoundingBox2D)() {
