...
#include "icrane_msgs/msg/detail/omniverse_info__rosidl_typesupport_fastrtps_c.h"
...
#include "icrane_msgs/msg/detail/modeling__functions.h"  // points
#include "icrane_msgs/msg/detail/tracked_entities__functions.h"  // boxes_info, people_info
#include "nav_msgs/msg/detail/path__functions.h"  // load_position
...
size_t get_serialized_size_icrane_msgs__msg__TrackedEntities(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_icrane_msgs__msg__TrackedEntities(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, icrane_msgs, msg, TrackedEntities)();
...
using _OmniverseInfo__ros_msg_type = icrane_msgs__msg__OmniverseInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _OmniverseInfo__ros_msg_type * ros_message = static_cast<const _OmniverseInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: people_info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, icrane_msgs, msg, TrackedEntities
      )()->data);
    size_t size = ros_message->people_info.size;
    auto array_ptr = ros_message->people_info.data;
  ...
  // Field name: boxes_info
  {
    ...
    auto array_ptr = ros_message->boxes_info.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, icrane_msgs, msg, Modeling
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _OmniverseInfo__ros_msg_type * ros_message = static_cast<_OmniverseInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: people_info
  {
    ...
    if (ros_message->people_info.data) {
      icrane_msgs__msg__TrackedEntities__Sequence__fini(&ros_message->people_info);
    }
    if (!icrane_msgs__msg__TrackedEntities__Sequence__init(&ros_message->people_info, size)) {
      return "failed to create array for field 'people_info'";
    }
    auto array_ptr = ros_message->people_info.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: boxes_info
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->boxes_info.data) {
      icrane_msgs__msg__TrackedEntities__Sequence__fini(&ros_message->boxes_info);
    }
    if (!icrane_msgs__msg__TrackedEntities__Sequence__init(&ros_message->boxes_info, size)) {
      return "failed to create array for field 'boxes_info'";
    }
    auto array_ptr = ros_message->boxes_info.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
size_t get_serialized_size_icrane_msgs__msg__OmniverseInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _OmniverseInfo__ros_msg_type * ros_message = static_cast<const _OmniverseInfo__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name people_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_icrane_msgs__msg__TrackedEntities(
  ...
  current_alignment += get_serialized_size_icrane_msgs__msg__Modeling(
    &(ros_message->points), current_alignment);

  return current_alignment - initial_alignment;
}

static uint32_t _OmniverseInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_icrane_msgs__msg__OmniverseInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_icrane_msgs
size_t max_serialized_size_icrane_msgs__msg__OmniverseInfo(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: people_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_icrane_msgs__msg__TrackedEntities(
        full_bounded, current_alignment);
    }
  }
  // member: boxes_info
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_icrane_msgs__msg__Modeling(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_icrane_msgs__msg__OmniverseInfo(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_OmniverseInfo = {
  "icrane_msgs::msg",
  "OmniverseInfo",
...
static rosidl_message_type_support_t _OmniverseInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_OmniverseInfo,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, icrane_msgs, msg, OmniverseInfo)() {
  return &_OmniverseInfo__type_support;
}
