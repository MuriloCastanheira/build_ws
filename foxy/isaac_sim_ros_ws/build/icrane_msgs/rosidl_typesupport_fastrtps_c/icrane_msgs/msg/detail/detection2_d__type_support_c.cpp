...
#include "icrane_msgs/msg/detail/detection2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "icrane_msgs/msg/detail/bounding_box2_d__functions.h"  // bbox
...
using _Detection2D__ros_msg_type = icrane_msgs__msg__Detection2D;
  ...
  // Field name: bbox
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, icrane_msgs, msg, BoundingBox2D
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_icrane_msgs__msg__BoundingBox2D(
...
static uint32_t _Detection2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_icrane_msgs__msg__Detection2D(
  ...
  size_t current_alignment)
{
  ...
  // member: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_icrane_msgs__msg__BoundingBox2D(
...
{
  return max_serialized_size_icrane_msgs__msg__Detection2D(
    full_bounded, 0);
}
