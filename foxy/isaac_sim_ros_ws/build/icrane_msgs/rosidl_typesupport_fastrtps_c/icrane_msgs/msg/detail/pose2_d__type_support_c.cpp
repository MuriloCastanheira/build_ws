...
#include "icrane_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Pose2D__ros_msg_type = icrane_msgs__msg__Pose2D;
...
static uint32_t _Pose2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_icrane_msgs__msg__Pose2D(
...
{
  return max_serialized_size_icrane_msgs__msg__Pose2D(
    full_bounded, 0);
}
