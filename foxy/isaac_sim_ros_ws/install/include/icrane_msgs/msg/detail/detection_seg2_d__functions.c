...
icrane_msgs__msg__DetectionSeg2D__init(icrane_msgs__msg__DetectionSeg2D * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->label)) {
    icrane_msgs__msg__DetectionSeg2D__fini(msg);
    return false;
  }
  // score
  // id
...
icrane_msgs__msg__DetectionSeg2D__create()
{
  ...
  icrane_msgs__msg__DetectionSeg2D * msg = (icrane_msgs__msg__DetectionSeg2D *)allocator.allocate(sizeof(icrane_msgs__msg__DetectionSeg2D), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(icrane_msgs__msg__DetectionSeg2D));
  bool success = icrane_msgs__msg__DetectionSeg2D__init(msg);
  if (!success) {
...
icrane_msgs__msg__DetectionSeg2D__Sequence__init(icrane_msgs__msg__DetectionSeg2D__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  icrane_msgs__msg__DetectionSeg2D * data = NULL;

  if (size) {
    data = (icrane_msgs__msg__DetectionSeg2D *)allocator.zero_allocate(size, sizeof(icrane_msgs__msg__DetectionSeg2D), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = icrane_msgs__msg__DetectionSeg2D__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        icrane_msgs__msg__DetectionSeg2D__fini(&data[i - 1]);
      }
...
icrane_msgs__msg__DetectionSeg2D__Sequence__fini(icrane_msgs__msg__DetectionSeg2D__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      icrane_msgs__msg__DetectionSeg2D__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  icrane_msgs__msg__DetectionSeg2D__Sequence * array = (icrane_msgs__msg__DetectionSeg2D__Sequence *)allocator.allocate(sizeof(icrane_msgs__msg__DetectionSeg2D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = icrane_msgs__msg__DetectionSeg2D__Sequence__init(array, size);
  if (!success) {
...
icrane_msgs__msg__DetectionSeg2D__Sequence__destroy(icrane_msgs__msg__DetectionSeg2D__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    icrane_msgs__msg__DetectionSeg2D__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
icrane_msgs__msg__DetectionSeg2D__Sequence__are_equal(const icrane_msgs__msg__DetectionSeg2D__Sequence * lhs, const icrane_msgs__msg__DetectionSeg2D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!icrane_msgs__msg__DetectionSeg2D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  icrane_msgs__msg__DetectionSeg2D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(icrane_msgs__msg__DetectionSeg2D);
    icrane_msgs__msg__DetectionSeg2D * data =
      (icrane_msgs__msg__DetectionSeg2D *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!icrane_msgs__msg__DetectionSeg2D__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          icrane_msgs__msg__DetectionSeg2D__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!icrane_msgs__msg__DetectionSeg2D__copy(
