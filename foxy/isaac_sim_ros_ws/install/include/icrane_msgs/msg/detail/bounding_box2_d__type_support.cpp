...
{
  new (message_memory) icrane_msgs::msg::BoundingBox2D(_init);
}

void BoundingBox2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<icrane_msgs::msg::BoundingBox2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox2D_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<icrane_msgs::msg::Pose2D>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs::msg::BoundingBox2D, center),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<icrane_msgs::msg::Vector2D>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs::msg::BoundingBox2D, size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox2D_message_members = {
  ...
  2,  // number of fields
  sizeof(icrane_msgs::msg::BoundingBox2D),
...
{
  return &::icrane_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, icrane_msgs, msg, BoundingBox2D)() {
  return &::icrane_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2D_message_type_support_handle;
}
