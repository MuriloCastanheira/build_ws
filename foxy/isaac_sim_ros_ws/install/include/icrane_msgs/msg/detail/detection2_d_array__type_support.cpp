...
#include "icrane_msgs/msg/detail/detection2_d_array__struct.hpp"
...
{
  new (message_memory) icrane_msgs::msg::Detection2DArray(_init);
}

void Detection2DArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<icrane_msgs::msg::Detection2DArray *>(message_memory);
  typed_message->~Detection2DArray();
}

size_t size_function__Detection2DArray__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<icrane_msgs::msg::Detection2D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<icrane_msgs::msg::Detection2D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<icrane_msgs::msg::Detection2D> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection2DArray_message_member_array[2] = {
  {
    ...
    offsetof(icrane_msgs::msg::Detection2DArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<icrane_msgs::msg::Detection2D>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(icrane_msgs::msg::Detection2DArray, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection2DArray_message_members = {
  ...
  2,  // number of fields
  sizeof(icrane_msgs::msg::Detection2DArray),
...
get_message_type_support_handle<icrane_msgs::msg::Detection2DArray>()
{
  return &::icrane_msgs::msg::rosidl_typesupport_introspection_cpp::Detection2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, icrane_msgs, msg, Detection2DArray)() {
  return &::icrane_msgs::msg::rosidl_typesupport_introspection_cpp::Detection2DArray_message_type_support_handle;
}
