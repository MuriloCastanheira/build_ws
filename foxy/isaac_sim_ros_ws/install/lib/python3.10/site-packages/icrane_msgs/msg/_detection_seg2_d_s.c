...
bool icrane_msgs__msg__detection_seg2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("icrane_msgs.msg._detection_seg2_d.DetectionSeg2D", full_classname_dest, 48) == 0);
  }
  icrane_msgs__msg__DetectionSeg2D * ros_message = _ros_message;
  {  // class_id
...
{
  /* NOTE(esteve): Call constructor of DetectionSeg2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("icrane_msgs.msg._detection_seg2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DetectionSeg2D");
