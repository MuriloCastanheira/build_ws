...
class Metaclass_DetectionSeg3D(type):
    """Metaclass of message 'DetectionSeg3D'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__detection_seg3_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__detection_seg3_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__detection_seg3_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__detection_seg3_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__detection_seg3_d
...
class DetectionSeg3D(metaclass=Metaclass_DetectionSeg3D):
    """Message class 'DetectionSeg3D'."""
    ...
    _fields_and_field_types = {
        ...
        'score': 'double',
        'id': 'string',
        'mask_pcd': 'sensor_msgs/PointCloud2',
    ...
    def __init__(self, **kwargs):
        ...
        from sensor_msgs.msg import PointCloud2
        self.mask_pcd = kwargs.get('mask_pcd', PointCloud2())
        from vision_msgs.msg import BoundingBox3D
    ...
    def __eq__(self, other):
        ...
        if self.id != other.id:
            return False
        if self.mask_pcd != other.mask_pcd:
            return False
    ...
    @property
    def mask_pcd(self):
        """Message field 'mask_pcd'."""
        return self._mask_pcd

    @mask_pcd.setter
    def mask_pcd(self, value):
        if __debug__:
            from sensor_msgs.msg import PointCloud2
            assert \
                isinstance(value, PointCloud2), \
                "The 'mask_pcd' field must be a sub message of type 'PointCloud2'"
        self._mask_pcd = value
