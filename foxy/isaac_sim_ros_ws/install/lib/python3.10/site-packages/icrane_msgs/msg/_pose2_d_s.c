...
bool icrane_msgs__msg__pose2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("icrane_msgs.msg._pose2_d.Pose2D", full_classname_dest, 31) == 0);
  }
  icrane_msgs__msg__Pose2D * ros_message = _ros_message;
  {  // x
...
PyObject * icrane_msgs__msg__pose2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("icrane_msgs.msg._pose2_d");
